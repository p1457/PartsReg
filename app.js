// Installatörs Delregister - Application Logic
    ...
    app.innerHTML = `
        <div class="bg-white rounded-xl shadow-lg p-6 mb-4">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Delregister</h1>
        ...
        <div class="text-center text-sm text-gray-600"><p>Installatörs Delregister v1.0</p></div>
    `;
}
...
function renderHome() {
    return `
        <div class="space-y-4">
            <h2 class="text-2xl font-bold text-gray-800">Nytt Projekt</h2>
            ...
            <button onclick="startProject()" class="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700">Fortsätt till delregistrering</button>
        </div>
    `;
}
...
async function generateExcel() {
    ...
    if (state.emailRecipients) {
        const subject = encodeURIComponent(`Delregister: ${state.currentProject.customer} - ${state.currentProject.project}`);
